...
- 🚧 **Agent 仍是 transport DTO 的主要剩余面**：Agent event WS 与 terminal WS contract 仍有手写重复；下一步迁移 canonical WS/event union，并增加 architecture guard 后做全量 regression/scenario 收尾。
