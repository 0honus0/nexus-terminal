...
<template>
  <OverlayPanel
    ...
    panel-class="max-w-2xl h-[min(78dvh,720px)] min-h-[min(360px,calc(100dvh-2rem))] flex flex-col overflow-hidden p-4"
    role="dialog"
    :aria-modal="true"
  ...
  >
    ...
    <div
      data-testid="suspended-sessions-modal-body"
      class="min-h-0 flex-1 overflow-hidden rounded border border-border"
    >
