...
export const defaultUiTheme: Record<string, string> = {
  ...
  '--input-bg-color': '#ffffff' /* 输入框背景色 */,
  '--input-text-color': 'var(--text-color)' /* 输入框文字颜色 */,
  '--input-placeholder-color': 'var(--text-color-secondary)' /* 输入框占位文字颜色 */,
  '--input-disabled-bg-color': '#f3f4f6' /* 输入框禁用背景色 */,
  '--input-disabled-text-color': '#6b7280' /* 输入框禁用文字颜色 */,
  '--input-disabled-placeholder-color': '#9ca3af' /* 输入框禁用占位文字颜色 */,
  '--input-disabled-border-color': '#d1d5db' /* 输入框禁用边框颜色 */,
...
export const darkUiTheme: Record<string, string> = {
  ...
  '--input-disabled-bg-color': '#0b1220',
  '--input-disabled-text-color': '#64748b',
  '--input-disabled-placeholder-color': '#475569',
