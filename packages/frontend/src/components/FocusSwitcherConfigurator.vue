      ...
      <div class="flex-grow p-6 flex flex-col gap-6 bg-background overflow-y-auto">
        ...
        <div class="flex gap-6 flex-shrink-0 min-h-[300px]">
          ...
          <section class="flex-1 p-4 border border-border rounded bg-input flex flex-col overflow-y-auto">
            <h3 class="mt-0 mb-4 text-base font-semibold text-text-secondary border-b border-border-light pb-2">
              ...
              <template #item="{ element }: { element: FocusableInput & FocusItemConfig }">
                ...
                >
                  <div class="flex items-center overflow-hidden">
                    ...
                    ></i>
                    <span class="flex-grow overflow-hidden text-ellipsis whitespace-nowrap mr-2 text-sm">{{
                      element.label
                    }}</span>
                  </div>
                </li>
              ...
              <template #item="{ element, index }: { element: SequenceDisplayItem; index: number }">
                ...
                >
                  <div class="flex items-center overflow-hidden">
                    ...
                    ></i>
                    <span class="item-label flex-grow overflow-hidden text-ellipsis whitespace-nowrap mr-2 text-sm">{{
                      element.label
                    }}</span>
                  </div>
                  <button
        ...
        <section class="p-4 border border-border rounded bg-input flex flex-col overflow-y-auto max-h-64 flex-shrink-0">
          ...
          <div class="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-3">
            ...
            >
              <span class="item-label flex-grow mr-3 overflow-hidden text-ellipsis whitespace-nowrap text-sm">{{
                input.label
              }}</span>
              <input
                type="text"
            ...
            <div
              v-if="!focusSwitcherStore.availableInputs || focusSwitcherStore.availableInputs.length === 0"
