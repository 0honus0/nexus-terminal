          ...
          >
            ...
            >
              <LayoutRenderer
                ...
                class="h-full w-full min-h-0 min-w-0 flex-grow overflow-hidden"
              />
            </pane>
          </splitpanes>
        </template>
        ...
        <template v-else-if="layoutNode.type === 'pane'">
          ...
          <template v-if="layoutNode.component === 'terminal'">
            ...
            >
              ...
              <div v-if="isTerminalBackgroundEnabled" class="shared-terminal-background-layers">
                <!-- Background Image -->
                <div class="terminal-background-image-layer" :style="terminalBackgroundImageStyle"></div>
                <!-- Color Overlay -->
                <div
              ...
              >
                <div class="flex flex-col items-center justify-center p-8 w-full h-full">
                  ...
                  <div class="text-xs text-text-secondary mt-2">
                    {{
                      activeSessionId
                        ? t('layout.noSshSessionActive.message', '请激活一个 SSH 会话以使用此终端面板。')
        ...
        >
          ...
          <component
            v-if="
              ...
              (activeLeftSidebarPane === 'statusMonitor' || activeLeftSidebarPane !== 'fileManager' || activeSession)
            "
        ...
        >
          ...
          <component
            v-if="
              ...
              (activeRightSidebarPane === 'statusMonitor' || activeRightSidebarPane !== 'fileManager' || activeSession)
            "
