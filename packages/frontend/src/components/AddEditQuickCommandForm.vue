<template>
  <OverlayPanel :surface="false" :close-on-backdrop="false" overlay-class="!p-0" data-testid="quick-command-form">
    <div
      ref="modalContentRef"
          ...
          <div class="flex-grow space-y-5 pr-1 flex flex-col">
            ...
            <div class="flex flex-col flex-grow">
              <label for="qc-command" class="block mb-1.5 text-sm font-medium text-text-secondary"
                >{{ t('quickCommands.form.command', '指令:') }} <span class="text-error">*</span></label
              >
              <textarea
                id="qc-command"
