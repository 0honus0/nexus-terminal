  ...
  <div data-testid="ip-whitelist-settings" class="settings-section-content">
    ...
    <form @submit.prevent="handleUpdateIpWhitelist" class="space-y-4">
      <div>
        ...
        <textarea data-testid="ip-whitelist-input" id="ipWhitelist" v-model="ipWhitelistInput" rows="4"
      ...
      <div class="flex items-center justify-between">
         <button data-testid="ip-whitelist-save" type="submit" :disabled="ipWhitelistLoading"
