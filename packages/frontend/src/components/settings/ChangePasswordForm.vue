<template>
  <div data-testid="change-password-settings" class="settings-section-content">
    ...
    <form @submit.prevent="handleChangePassword" class="space-y-4">
      <div>
        ...
        <input data-testid="change-password-current" type="password" id="currentPassword" v-model="currentPassword" required
      ...
      <div>
        ...
        <input data-testid="change-password-new" type="password" id="newPassword" v-model="newPassword" required
               class="w-full px-3 py-2 border border-border rounded-md shadow-sm bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary">
      </div>
      <div>
        ...
        <input data-testid="change-password-confirm" type="password" id="confirmPassword" v-model="confirmPassword" required
               class="w-full px-3 py-2 border border-border rounded-md shadow-sm bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary">
      </div>
      <div class="flex items-center justify-between">
        <button data-testid="change-password-submit" type="submit" :disabled="changePasswordLoading"
