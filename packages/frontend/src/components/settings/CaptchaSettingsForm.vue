  ...
  <div data-testid="captcha-settings" class="settings-section-content">
    ...
    <form v-else @submit.prevent="handleUpdateCaptchaSettings" class="space-y-4">
      ...
      >
        ...
        <div>
          <label for="hcaptchaSecretKey" class="block text-sm font-medium text-text-secondary mb-1">{{
            $t('settings.captcha.secretKeyLabel')
          }}</label>
          <input
            type="password"
      ...
      >
        ...
        <div>
          <label for="recaptchaSiteKey" class="block text-sm font-medium text-text-secondary mb-1">{{
            $t('settings.captcha.siteKeyLabel')
          }}</label>
          <input
            type="text"
        ...
        <div>
          <label for="recaptchaSecretKey" class="block text-sm font-medium text-text-secondary mb-1">{{
            $t('settings.captcha.secretKeyLabel')
          }}</label>
          <input
            type="password"
      ...
      <div class="flex items-center justify-between pt-2">
        ...
        <p v-if="captchaMessage" :class="['text-sm', captchaSuccess ? 'text-success' : 'text-error']">
          {{ captchaMessage }}
        </p>
      </div>
    </form>
