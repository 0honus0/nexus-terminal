<template>
  <div class="settings-section-content">
    ...
    <p v-if="passkeyMessage" :class="['mt-3 text-sm', passkeySuccess ? 'text-success' : 'text-error']">
      {{ passkeyMessage }}
    </p>
            ...
            <div class="flex-grow mb-2 sm:mb-0">
              <div class="flex items-center">
                ...
                >
                  ...
                  <span class="text-xs text-text-tertiary ml-1"
                    >(ID: ...{{
                      typeof key.credentialID === 'string' && key.credentialID ? key.credentialID.slice(-8) : 'N/A'
                    }})</span
                  >
                </span>
              ...
              <div class="text-xs text-text-secondary mt-1 space-x-2">
                ...
                <span v-if="key.lastUsedDate"
                  >{{ $t('settings.passkey.lastUsedDate') }}: {{ formatDate(key.lastUsedDate) }}</span
                >
