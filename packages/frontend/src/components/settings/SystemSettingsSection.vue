    ...
    <div class="p-6 space-y-6">
      ...
      <div class="settings-section-content">
        ...
        <form @submit.prevent="handleUpdateLanguage" class="space-y-4">
          <div>
            <label for="languageSelect" class="block text-sm font-medium text-text-secondary mb-1">{{
          ...
          <div class="flex items-center justify-between">
            ...
            <p v-if="languageMessage" :class="['text-sm', languageSuccess ? 'text-success' : 'text-error']">
              {{ languageMessage }}
            </p>
          </div>
        </form>
      ...
      <div class="settings-section-content">
        ...
        <form @submit.prevent="handleUpdateTimezone" class="space-y-4">
          <div>
            <label for="timezoneSelect" class="block text-sm font-medium text-text-secondary mb-1">{{
          ...
          <div class="flex items-center justify-between">
            ...
            <p v-if="timezoneMessage" :class="['text-sm', timezoneSuccess ? 'text-success' : 'text-error']">
              {{ timezoneMessage }}
            </p>
          </div>
        </form>
