...
<template>
  <OverlayPanel :visible="isVisible" :z-index="1000" :surface="false" overlay-class="!p-0" @close="closeDialog">
    <div
      ref="dialogRef"
                ...
                <template #item="{ element, index }: { element: PaneName; index: number }">
                  ...
                  >
                    <div class="flex items-center overflow-hidden">
                      ...
                      ></i>
                      <span class="flex-grow mr-2 overflow-hidden text-ellipsis whitespace-nowrap">{{
                        paneLabels[element] || element
                      }}</span>
                    </div>
                    <button
