...
<template>
  <div id="app-container">
    ...
    <header
      v-if="!isWorkspaceRoute || isHeaderVisible"
      class="sticky top-0 z-10 flex items-center h-14 pl-3 pr-6 bg-header border-b border-border shadow-sm"
    >
      <!-- 减少左侧内边距 -->
      ...
      <nav ref="navRef" class="flex items-center justify-between w-full relative">
        ...
        <div class="flex items-center space-x-1">
          <!-- 项目 Logo -->
          <img src="./assets/logo.png" alt="Project Logo" class="h-10 w-auto" />
          <!-- 移除右侧外边距，使其更靠左 -->
          <RouterLink
            to="/"
            class="inline-flex px-3 py-2 rounded-md text-sm font-medium text-secondary hover:text-link-hover hover:bg-nav-active-bg hover:no-underline transition duration-150 ease-in-out whitespace-nowrap"
            active-class="text-link-active bg-nav-active-bg"
          ...
          <RouterLink
            to="/connections"
            class="hidden md:inline-flex px-3 py-2 rounded-md text-sm font-medium text-secondary hover:text-link-hover hover:bg-nav-active-bg hover:no-underline transition duration-150 ease-in-out whitespace-nowrap"
            active-class="text-link-active bg-nav-active-bg"
        ...
        <div class="flex items-center space-x-1">
          ...
          <RouterLink
            ...
            to="/login"
            class="px-3 py-2 rounded-md text-sm font-medium text-secondary hover:text-link-hover hover:bg-nav-active-bg hover:no-underline transition duration-150 ease-in-out whitespace-nowrap"
