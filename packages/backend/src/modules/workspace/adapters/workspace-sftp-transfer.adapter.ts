...
import type { SftpTransferContext, SftpTransferEvent } from '../../../platform/operations/transfer/sftp-transfer.types';
...
export class WorkspaceSftpTransferAdapter {
  ...
  private sendEvent(ws: WorkspaceClient | undefined, event: SftpTransferEvent): void {
