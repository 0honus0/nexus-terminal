...
import { TerminalTheme, CreateTerminalThemeDto, UpdateTerminalThemeDto } from '../../shared/types/terminal-theme.types';
...
export const initializePresetThemes = async (
  db: Database,
  presets: Array<Omit<TerminalTheme, '_id' | 'createdAt' | 'updatedAt' | 'isSystemDefault'> & { name: string }>,
) => {
