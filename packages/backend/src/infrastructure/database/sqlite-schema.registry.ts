...
export const sqliteTableDefinitions: readonly SqliteTableDefinition[] = [
  ...
  { name: 'ai_context_checkpoints', sql: schema.createAiContextCheckpointsTableSQL },
  { name: 'ai_memories', sql: schema.createAiMemoriesTableSQL },
  { name: 'ai_memories_search', sql: schema.createAiMemorySearchIndexSQL },
  ...
  { name: 'agent_input_requests', sql: schema.createAgentInputRequestsTableSQL },
