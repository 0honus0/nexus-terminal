...
import * as appearanceRepository from '../../modules/appearance/appearance.repository';
import * as terminalThemeRepository from '../../modules/terminal-themes/terminal-theme.repository';
