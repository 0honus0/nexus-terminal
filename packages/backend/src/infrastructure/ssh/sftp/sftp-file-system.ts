...
import type { FileAttributes, FileEntry, FileSearchResult, ReadFileResult, RealPathResult } from '../../../platform/filesystem/types';
import type { RemoteDirectoryEntry, RemoteFileMetadata, RemoteFileSystem, RemoteReadRange } from '../../../platform/filesystem/remote-filesystem';
