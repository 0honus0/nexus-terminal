...
import * as QuickCommandsService from '../../../modules/quick-commands/quick-commands.service';
import { QuickCommandSortBy } from '../../../modules/quick-commands/quick-commands.service';
 ...
 * 处理更新快捷指令的请求
 */
export const updateQuickCommand = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
 ...
 * 处理删除快捷指令的请求
 */
export const deleteQuickCommand = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  const id = parseInt(req.params.id, 10);
