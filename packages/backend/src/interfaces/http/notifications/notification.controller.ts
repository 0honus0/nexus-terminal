...
import { NotificationSettingsRepository } from '../../../modules/notifications/notification.repository'; // Use repository
import {
  NotificationSetting,
...
import { AppEventType, default as eventService } from '../../../shared/events/app-event.service'; // Import event service
