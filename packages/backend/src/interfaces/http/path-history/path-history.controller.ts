...
import * as PathHistoryService from '../../../modules/path-history/path-history.service';
 ...
 * 处理根据 ID 删除路径历史记录的请求
 */
export const deletePath = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
